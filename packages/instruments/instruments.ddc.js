define(['dart_sdk'], function(dart_sdk) {
  ...
  const instruments = Object.create(dart.library);
  const $isEmpty = dartx.isEmpty;
  const $contains = dartx.contains;
  const $querySelectorAll = dartx.querySelectorAll;
  const $shadowRoot = dartx.shadowRoot;
  ...
  let StreamControllerOfNoteEvent = () => (StreamControllerOfNoteEvent = dart.constFn(async.StreamController$(instruments.NoteEvent)))();
  ...
  let JSArrayOfDrumPad = () => (JSArrayOfDrumPad = dart.constFn(_interceptors.JSArray$(instruments.DrumPad)))();
  let IdentityMapOfString$String = () => (IdentityMapOfString$String = dart.constFn(_js_helper.IdentityMap$(core.String, core.String)))();
  let MouseEventToNull = () => (MouseEventToNull = dart.constFn(dart.fnType(core.Null, [html.MouseEvent])))();
  let JSArrayOfPianoKey = () => (JSArrayOfPianoKey = dart.constFn(_interceptors.JSArray$(instruments.PianoKey)))();
  let PianoKeyTovoid = () => (PianoKeyTovoid = dart.constFn(dart.fnType(dart.void, [instruments.PianoKey])))();
  let VoidToNull = () => (VoidToNull = dart.constFn(dart.fnType(core.Null, [])))();
  let JSArrayOfnum = () => (JSArrayOfnum = dart.constFn(_interceptors.JSArray$(core.num)))();
  let JSArrayOfString = () => (JSArrayOfString = dart.constFn(_interceptors.JSArray$(core.String)))();
  let JSArrayOfDrum = () => (JSArrayOfDrum = dart.constFn(_interceptors.JSArray$(instruments.Drum)))();
  ...
  const _stream = dart.privateName(instruments, "_stream");
  const _armed = dart.privateName(instruments, "_armed");
  const _ports = dart.privateName(instruments, "_ports");
  const _resize = dart.privateName(instruments, "_resize");
  const _render = dart.privateName(instruments, "_render");
  const _onKeyDown = dart.privateName(instruments, "_onKeyDown");
  const _onKeyUp = dart.privateName(instruments, "_onKeyUp");
  const _addNoteEvent = dart.privateName(instruments, "_addNoteEvent");
  const name$ = dart.privateName(instruments, "Instrument.name");
  const root = dart.privateName(instruments, "Instrument.root");
  const container = dart.privateName(instruments, "Instrument.container");
  const parent = dart.privateName(instruments, "Instrument.parent");
  const width = dart.privateName(instruments, "Instrument.width");
  const height = dart.privateName(instruments, "Instrument.height");
  instruments.Instrument = class Instrument extends core.Object {
    ...
    armMidi(ports) {
      ...
      this[_ports] = ports == null ? JSArrayOfint().of([]) : ports;
    }
    disarmMidi() {
      this[_ports] = null;
    }
    ...
    insert(element) {
      let template = html.TemplateElement._check(html.querySelector("#" + dart.str(this.name) + "-template"));
      ...
      html.window[$onResize].listen(dart.fn(e => this[_resize](), EventTovoid()));
      this[_resize]();
      this[_render]();
    ...
    unload() {
      if (this.root != null) {
        this.root[$children][$forEach](dart.fn(child => child[$remove](), ElementTovoid()));
      }
    }
    [_addNoteEvent](e) {
      this[_stream].add(e);
  ...
  (instruments.Instrument.new = function(name) {
    this[name$] = "piano";
    this[_stream] = StreamControllerOfNoteEvent().new();
    this[root] = null;
    this[container] = null;
  ...
  dart.setLibraryUri(instruments.Instrument, "package:instruments/instruments.dart");
  ...
  const message$ = dart.privateName(instruments, "NoteEvent.message");
  const source$ = dart.privateName(instruments, "NoteEvent.source");
  const time = dart.privateName(instruments, "NoteEvent.time");
  const note$ = dart.privateName(instruments, "NoteEvent.note");
  const velocity$ = dart.privateName(instruments, "NoteEvent.velocity");
  const value$ = dart.privateName(instruments, "NoteEvent.value");
  ...
  dart.setLibraryUri(instruments.NoteEvent, "package:instruments/instruments.dart");
  ...
  const _group = dart.privateName(instruments, "_group");
  const _noteToPad = dart.privateName(instruments, "_noteToPad");
  const pads = dart.privateName(instruments, "Drums.pads");
  const key_map = dart.privateName(instruments, "Drums.key_map");
  instruments.Drums = class Drums extends instruments.Instrument {
    ...
    noteOn(note, velocity) {
      if (velocity === void 0) velocity = 90;
        ...
        if (dart.equals(node[$_get]("type"), "sample") && core.List.is(node[$_get]("samples"))) {
          for (let t1 of core.Iterable._check(node[$_get]("samples"))) {
            ...
            if (core.int.is(sample[$_get]("step"))) {
              ...
              let midi = core.int._check(sample[$_get]("step"));
  ...
  dart.setLibraryUri(instruments.Drums, "package:instruments/instruments.dart");
  ...
  const _keyHint = dart.privateName(instruments, "_keyHint");
  const _midiHint = dart.privateName(instruments, "_midiHint");
  const _text = dart.privateName(instruments, "_text");
  const _rect = dart.privateName(instruments, "_rect");
  const _down = dart.privateName(instruments, "_down");
  const drums$ = dart.privateName(instruments, "DrumPad.drums");
  const row$ = dart.privateName(instruments, "DrumPad.row");
  const col$ = dart.privateName(instruments, "DrumPad.col");
  const midi$ = dart.privateName(instruments, "DrumPad.midi");
  const name$0 = dart.privateName(instruments, "DrumPad.name");
  ...
  (instruments.DrumPad.new = function(drums, row, col, midi, name) {
    ...
    this[midi$] = midi;
    this[name$0] = name;
    this[_rect][$attributes] = new (IdentityMapOfString$String()).from(["class", "drum-pad", "x", dart.str(instruments.DrumPad.padding), "y", dart.str(instruments.DrumPad.padding)]);
    this[_group][$append](this[_rect]);
    this[_text][$attributes] = new (IdentityMapOfString$String()).from(["class", "drum-name"]);
    this[_text][$innerHtml] = this.name[$toUpperCase]();
    this[_group][$append](this[_text]);
    this[_keyHint][$attributes] = new (IdentityMapOfString$String()).from(["class", "key-hint"]);
    ...
    this[_midiHint][$attributes] = new (IdentityMapOfString$String()).from(["class", "midi-hint show"]);
  ...
  dart.setLibraryUri(instruments.DrumPad, "package:instruments/instruments.dart");
  ...
  const _slideKeyboard = dart.privateName(instruments, "_slideKeyboard");
  const _noteToKey = dart.privateName(instruments, "_noteToKey");
  const _updateKeymap = dart.privateName(instruments, "_updateKeymap");
  const keys = dart.privateName(instruments, "Piano.keys");
  const offset = dart.privateName(instruments, "Piano.offset");
  const mini = dart.privateName(instruments, "Piano.mini");
  const key_map$ = dart.privateName(instruments, "Piano.key_map");
  const allKeys = dart.privateName(instruments, "Piano.allKeys");
  instruments.Piano = class Piano extends instruments.Instrument {
    ...
    loadState(saved) {
      if (core.int.is(saved[$_get]("offset"))) {
        this.offset = core.int._check(saved[$_get]("offset"));
    ...
    [_render]() {
      let t2, t2$, t2$0;
      let backdrop = (t2 = svg.RectElement.new(), t2[$attributes] = new (IdentityMapOfString$String()).from(["class", "backdrop", "width", "100%", "height", "100%"]), t2);
      ...
      let felt = (t2$ = svg.RectElement.new(), t2$[$attributes] = new (IdentityMapOfString$String()).from(["class", "felt", "width", "100%", "height", "2", "x", "0", "y", "0"]), t2$);
      this.parent[$append](felt);
      let shelf = (t2$0 = svg.RectElement.new(), t2$0[$attributes] = new (IdentityMapOfString$String()).from(["width", "100%", "height", "8", "x", "0", "y", "0", "fill", "black", "fill-opacity", "0.05", "filter", "url(#drop-shadow)"]), t2$0);
    ...
    [_slideKeyboard](delta) {
      this.keys[$forEach](dart.fn(key => key.autoRelease(), PianoKeyTovoid()));
      this.offset = dart.notNull(this.offset) + dart.notNull(delta);
      this.offset = dart.asInt(this.offset[$clamp](0, dart.notNull(this.keys[$length]) - 24));
  ...
  (instruments.Piano.new = function() {
    this[keys] = JSArrayOfPianoKey().of([]);
    this[offset] = 0;
    this[mini] = null;
  ...
  dart.setLibraryUri(instruments.Piano, "package:instruments/instruments.dart");
  ...
  const _timer = dart.privateName(instruments, "_timer");
  const Duration__duration = dart.privateName(core, "Duration._duration");
  let C0;
  const piano$ = dart.privateName(instruments, "MiniPiano.piano");
  const el = dart.privateName(instruments, "MiniPiano.el");
  const bkeys = dart.privateName(instruments, "MiniPiano.bkeys");
  const wkeys = dart.privateName(instruments, "MiniPiano.wkeys");
  const highlight = dart.privateName(instruments, "MiniPiano.highlight");
  instruments.MiniPiano = class MiniPiano extends core.Object {
    ...
    render() {
      ...
      let backdrop = (t2 = svg.RectElement.new(), t2[$attributes] = new (IdentityMapOfString$String()).from(["x", dart.str(dart.notNull(instruments.PianoKey.width) * 5), "fill", "black", "width", dart.str(dart.notNull(this.width) - 200), "height", dart.str(this.height)]), t2);
      ...
      for (let key of this.piano.keys) {
        ...
        if (dart.notNull(key.key) > 8) {
          let r = (t2$ = svg.RectElement.new(), t2$[$attributes] = new (IdentityMapOfString$String()).from(["fill", fill, "x", dart.str(dart.notNull(key.x) + pad), "y", "2", "width", dart.str(dart.notNull(instruments.PianoKey.width) - pad * 2), "height", dart.str(key.height)]), t2$);
          dart.test(key.black) ? this.bkeys[$append](r) : this.wkeys[$append](r);
        }
      }
      this.el[$append](this.wkeys);
      this.el[$append](this.bkeys);
      this.highlight[$attributes] = new (IdentityMapOfString$String()).from(["fill", "#900", "fill-opacity", "0.35", "stroke", "#900", "width", dart.str(this.piano.width), "height", dart.str(this.height), "x", "0", "y", "0"]);
  ...
  dart.setLibraryUri(instruments.MiniPiano, "package:instruments/instruments.dart");
  ...
  const _key_offsets = dart.privateName(instruments, "_key_offsets");
  const key$ = dart.privateName(instruments, "PianoKey.key");
  const piano$0 = dart.privateName(instruments, "PianoKey.piano");
  const keyHint = dart.privateName(instruments, "PianoKey.keyHint");
  const el$ = dart.privateName(instruments, "PianoKey.el");
  const rect = dart.privateName(instruments, "PianoKey.rect");
  instruments.PianoKey = class PianoKey extends core.Object {
    ...
    get black() {
      return JSArrayOfint().of([1, 3, 6, 8, 10])[$contains](this.step);
    }
    get white() {
  ...
  (instruments.PianoKey.new = function(key, piano) {
    ...
    this[_key_offsets] = JSArrayOfnum().of([0, 0.45, 1, 1.55, 2, 3, 3.4, 4, 4.5, 5, 5.6, 6]);
    this[el$] = svg.GElement.new();
    this[rect] = svg.RectElement.new();
    this[_down] = false;
    this[key$] = key;
    this[piano$0] = piano;
    this.el = (t2 = svg.GElement.new(), t2[$attributes] = new (IdentityMapOfString$String()).from(["transform", "translate(" + dart.str(this.x) + ", 0)"]), t2);
    let pad = dart.test(this.black) ? 6 : 1.5;
    let x0 = pad;
    let w = dart.notNull(instruments.PianoKey.width) - pad * 2;
    let h = this.height;
    this.rect[$attributes] = new (IdentityMapOfString$String()).from(["class", dart.test(this.black) ? "piano-key black" : "piano-key white", "x", dart.str(x0), "y", "-3", "width", dart.str(w), "height", dart.str(h)]);
    this.el[$append](this.rect);
    if (dart.test(this.black)) {
      x0 = x0 + 2;
      w = w - 4;
      let r = (t2$ = svg.RectElement.new(), t2$[$attributes] = new (IdentityMapOfString$String()).from(["x", dart.str(x0), "y", "2", "width", dart.str(w), "height", dart.str(dart.notNull(h) - 15), "fill", "#334", "pointer-events", "none"]), t2$);
      this.el[$append](r);
    } else {
      let noteHint = (t2$0 = svg.TextElement.new(), t2$0[$attributes] = new (IdentityMapOfString$String()).from(["class", "note-hint", "x", dart.str(x0 + w / 2), "y", dart.str(dart.notNull(h) - 8)]), t2$0);
      noteHint[$innerHtml] = dart.str(this.name) + dart.str(this.octave);
      if (this.step === 0) {
        noteHint[$classes].add("always-show");
      }
      this.el[$append](noteHint);
      let midiHint = (t2$1 = svg.TextElement.new(), t2$1[$attributes] = new (IdentityMapOfString$String()).from(["class", "midi-hint show", "x", dart.str(x0 + w / 2), "y", dart.str(dart.notNull(h) - 24)]), t2$1);
      midiHint[$innerHtml] = dart.str(this.midi);
      this.el[$append](midiHint);
    }
    this.keyHint[$attributes] = new (IdentityMapOfString$String()).from(["class", "key-hint", "x", dart.str(x0 + w / 2), "y", dart.str(dart.notNull(h) - 42)]);
  ...
  dart.setLibraryUri(instruments.PianoKey, "package:instruments/instruments.dart");
  ...
  dart.defineLazy(instruments.PianoKey, {
    /*instruments.PianoKey.NOTES*/get NOTES() {
      return JSArrayOfString().of(["C", "C#", "D", "D#", "E", "F", "F#", "G", "G#", "A", "A#", "B"]);
    }
  });
  const _noteToDrum = dart.privateName(instruments, "_noteToDrum");
  const _showHint = dart.privateName(instruments, "_showHint");
  const _hideHint = dart.privateName(instruments, "_hideHint");
  const key_map$0 = dart.privateName(instruments, "DrumKit.key_map");
  const drums = dart.privateName(instruments, "DrumKit.drums");
  const selector$ = dart.privateName(instruments, "DrumKit.selector");
  instruments.DrumKit = class DrumKit extends instruments.Instrument {
    ...
    [_showHint](drum) {
      let div = html.DivElement._check(this.root.querySelector(".drum-hint"));
      if (div != null) {
  ...
  (instruments.DrumKit.new = function(selector, patch) {
    ...
    this[drums] = JSArrayOfDrum().of([]);
    this[selector$] = selector;
    instruments.DrumKit.__proto__.new.call(this, "drumkit");
    if (core.List.is(patch[$_get]("nodes"))) {
      for (let t2 of core.Iterable._check(patch[$_get]("nodes"))) {
        let node = core.Map._check(t2);
        if (dart.equals(node[$_get]("type"), "sample") && core.List.is(node[$_get]("samples"))) {
          for (let t3 of core.Iterable._check(node[$_get]("samples"))) {
            let sample = core.Map._check(t3);
            if (core.int.is(sample[$_get]("step"))) {
              let midi = core.int._check(sample[$_get]("step"));
              let name = dart.str(sample[$_get]("name"));
  ...
  dart.setLibraryUri(instruments.DrumKit, "package:instruments/instruments.dart");
  ...
  const selector$0 = dart.privateName(instruments, "Drum.selector");
  const name$1 = dart.privateName(instruments, "Drum.name");
  const midi$0 = dart.privateName(instruments, "Drum.midi");
  const pressed = dart.privateName(instruments, "Drum.pressed");
  ...
  dart.setLibraryUri(instruments.Drum, "package:instruments/instruments.dart");

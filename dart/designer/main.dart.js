...
(function dartProgram() {
  ...
  F = {Note: function Note() {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t2 = Y.Datastore$rest("https://tunepad.club", "wss://tunepad.club/websocket/");
              $.datastore = t2;
              t2 = t2._logout_stream;
              new P._ControllerStream(t2, H._instanceType(t2)._eval$1("_ControllerStream<1>")).listen$1(new F.main_closure());
              t2 = $.datastore._updated_stream;
              new P._ControllerStream(t2, H._instanceType(t2)._eval$1("_ControllerStream<1>")).listen$1(F.main__patchUpdated$closure());
              t2 = $.datastore._created_stream;
              new P._ControllerStream(t2, H._instanceType(t2)._eval$1("_ControllerStream<1>")).listen$1(F.main__patchCreated$closure());
              t2 = $.datastore._deleted_stream;
              new P._ControllerStream(t2, H._instanceType(t2)._eval$1("_ControllerStream<1>")).listen$1(F.main__patchDeleted$closure());
              $async$goto = 2;
    ...
    draw: function(t) {
      ...
      if (t1.__js_helper$_length === 1) {
        t1 = t1.get$values(t1);
        t1 = t1._f.call$1(J.get$first$ax(t1.__internal$_iterable)) != null;
      } else
        t1 = false;
      if (t1) {
        ...
        t1 = $.$get$notes();
        t1 = t1.get$values(t1);
        t1 = t1._f.call$1(J.get$first$ax(t1.__internal$_iterable)).note._note;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = type$.dynamic;
              patch = new Y.SynthPatch(P.LinkedHashMap_LinkedHashMap$_empty(t1, t1), -1, new P.DateTime(Date.now(), false), new P.DateTime(Date.now(), false));
  ...
  Y = {
    Datastore$rest: function(host, wss) {
      ...
      t2 = new Y.User(C.C__JSRandom, null, new P.DateTime(Date.now(), false), new P.DateTime(Date.now(), false));
      t2.id = K.Uuid$().v1$0();
      t2.name = "Anonymous";
      ...
      t4 = P.StreamController_StreamController(t3);
      t5 = P.StreamController_StreamController(t3);
      t6 = P.StreamController_StreamController(t3);
      t7 = P.StreamController_StreamController(t3);
      t3 = P.StreamController_StreamController(t3);
      t8 = type$.JsLinkedHashMap_of_String_and_List_Function;
      t1 = new Y.Datastore(t1, host, t2, t4, t5, t6, t7, t3, new H.JsLinkedHashMap(t8), new H.JsLinkedHashMap(t8), new H.JsLinkedHashMap(t8));
      t1.Datastore$rest$2(host, wss);
      return t1;
    },
    DataModel_DataModel$fromJson: function(json) {
      var t1, t2, patch, t3, recording, _s4_ = "type",
        _s9_ = "recording";
      if (json == null || J.$index$asx(json, _s4_) == null)
        return null;
      else {
        t1 = J.getInterceptor$asx(json);
        if (J.$eq$(t1.$index(json, _s4_), "patch")) {
          t2 = type$.dynamic;
          patch = new Y.SynthPatch(P.LinkedHashMap_LinkedHashMap$_empty(t2, t2), H._asIntNullable(t1.$index(json, "id")), new P.DateTime(Date.now(), false), new P.DateTime(Date.now(), false));
          patch.voice = "My Patch";
          patch.type = "patch";
          patch.load$1(0, json);
          return patch;
        } else if (J.$eq$(t1.$index(json, _s4_), _s9_)) {
          t1 = H._asIntNullable(t1.$index(json, "id"));
          t2 = D.GrowableAudioBuffer$();
          t3 = D.GrowableAudioBuffer$();
          recording = new Y.Recording(t2, t3, new H.JsLinkedHashMap(type$.JsLinkedHashMap_String_num), t1, new P.DateTime(Date.now(), false), new P.DateTime(Date.now(), false));
    ...
    DatastoreEvent$fromJson: function(json) {
      var t1 = new Y.DatastoreEvent(null, "created", false);
    ...
    Datastore: function Datastore(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10) {
      var _ = this;
      _._credentials = t0;
      _.host = t1;
      _.wid = _.socket = null;
    ...
    Datastore$rest_closure: function Datastore$rest_closure() {
    },
    Datastore$rest_closure0: function Datastore$rest_closure0(t0) {
      this.wss = t0;
    },
  ...
  var holders = [C, H, J, P, W, D, U, N, R, K, X, B, F, L, Y, Z, V, O, T];
  ...
  P._StreamController.prototype = {
    ...
    _subscribe$4: function(onData, onError, onDone, cancelOnError) {
      ...
      subscription = new P._ControllerSubscription(_this, t3, t4, t1._eval$1("_ControllerSubscription<1>"));
      subscription._BufferingStreamSubscription$4(onData, onError, onDone, cancelOnError, t1._precomputed1);
      ...
      t1 = t2._as(new P._StreamController__subscribe_closure(_this));
  ...
  W._StreamPool.prototype = {
    ...
    close$0: function(_) {
      var t1, t2, t3;
      for (t1 = this._subscriptions, t2 = t1.get$values(t1), t3 = H._instanceType(t2), t3 = new H.MappedIterator(J.get$iterator$ax(t2.__internal$_iterable), t2._f, t3._eval$1("@<1>")._bind$1(t3._rest[1])._eval$1("MappedIterator<1,2>")); t3.moveNext$0();)
  ...
  Y.Datastore.prototype = {
    Datastore$rest$2: function(host, wss) {
      var t1, t2, _this = this;
      ...
      t1 = type$.Event;
      W._EventStreamSubscription$(_this.socket, "error", t2._as(new Y.Datastore$rest_closure()), false, t1);
      W._EventStreamSubscription$(_this.socket, "open", t2._as(new Y.Datastore$rest_closure0(wss)), false, t1);
    },
    connect$0: function() {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(type$.dynamic),
        $async$handler = 1, $async$currentError, $async$next = [], $async$self = this, data, t1, t2, t3, t4, t5, exception, $async$exception;
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 6:
              ...
              if (t1._is(data) && H.boolConversionCheck(J.containsKey$1$x(data, "id"))) {
                t2 = J.$index$asx(data, "id");
                t2 = $async$self.user = new Y.User(C.C__JSRandom, t2, new P.DateTime(Date.now(), false), new P.DateTime(Date.now(), false));
                t1 = t1._as(data);
                t3 = J.getInterceptor$asx(t1);
                t4 = t3.$index(t1, "id");
                t2.id = t4 == null ? null : J.toString$0$(t4);
                t4 = t3.$index(t1, "username");
                t2.name = t4 == null ? null : J.toString$0$(t4);
                t4 = t3.$index(t1, "email");
                t2.email = t4 == null ? null : J.toString$0$(t4);
                t2.anonymous = B.toBool(t3.$index(t1, "anonymous"), true);
                t4 = t3.$index(t1, "color");
                t5 = t2._loadColor$0();
                t2.color = t4 == null ? t5 : J.toString$0$(t4);
                t4 = t3.$index(t1, "icon");
                t5 = t2._loadIcon$0();
                t2.icon = t4 == null ? t5 : J.toString$0$(t4);
                t4 = t3.$index(t1, "photo");
                t5 = t2._loadPhoto$0();
                t2.photo = t4 == null ? t5 : J.toString$0$(t4);
                t4 = t3.$index(t1, "displayName");
                t5 = t2._loadDisplayName$0();
                t2.displayName = t4 == null ? t5 : J.toString$0$(t4);
                t2.created = B.toDateTime(t3.$index(t1, "created"));
                t2.modified = B.toDateTime(t3.$index(t1, "modified"));
              }
              $async$handler = 1;
              // goto after finally
              $async$goto = 5;
            ...
            case 5:
              // after finally
              $async$self._login_stream.add$1(0, new Y.DatastoreEvent($async$self.user, "login", false));
              // implicit return
              return P._asyncReturn(null, $async$completer);
            case 1:
              // rethrow
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return P._asyncAwait($async$self._createSynthPatch$1(object), $async$create$1);
            case 3:
              // returning from await.
              result = $async$result;
              result = result;
              if (result != null) {
                $async$self._created_stream.add$1(0, new Y.DatastoreEvent(result, "created", false));
                $async$self._broadcastEvent$1(new Y.DatastoreEvent(result, "created", true));
              }
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return P._asyncAwait($async$self._getSynthPatch$1(H._asIntNullable(object.id)), $async$retrieve$1);
            case 3:
              // returning from await.
              t1 = $async$result;
      ...
      var $async$update$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = object instanceof Y.SynthPatch ? 3 : 5;
              break;
            case 3:
              // then
              $async$goto = 6;
              return P._asyncAwait($async$self._updateSynthPatch$1(object), $async$update$1);
            case 6:
              // returning from await.
              // goto join
              $async$goto = 4;
            ...
            case 4:
              ...
              result = $async$result;
              if (result != null) {
                $async$self._updated_stream.add$1(0, new Y.DatastoreEvent(result, "updated", false));
                $async$self._broadcastEvent$1(new Y.DatastoreEvent(result, "updated", true));
              }
              $async$returnValue = result;
              // goto return
              $async$goto = 1;
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              // then
              $async$goto = 6;
              return P._asyncAwait($async$self._deleteSynthPatch$1(object), $async$delete$1);
            case 6:
              // returning from await.
              // goto join
              $async$goto = 4;
            ...
            case 4:
              ...
              result = $async$result;
              if (result != null) {
                $async$self._deleted_stream.add$1(0, new Y.DatastoreEvent(result, "deleted", false));
                $async$self._broadcastEvent$1(new Y.DatastoreEvent(result, "deleted", true));
              }
              $async$returnValue = result;
              // goto return
              $async$goto = 1;
    ...
    _createSynthPatch$1: function(patch) {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(type$.SynthPatch),
        $async$returnValue, $async$self = this, data, t1;
      var $async$_createSynthPatch$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return P._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              patch.username = $async$self.user.displayName;
              patch.deleted = patch.$public = false;
              $async$goto = 3;
              return P._asyncAwait($async$self._sendJSON$3("/api/patch/", "POST", patch.save$0(0)), $async$_createSynthPatch$1);
            case 3:
              // returning from await.
              data = $async$result;
              t1 = type$.dynamic;
              t1 = new Y.SynthPatch(P.LinkedHashMap_LinkedHashMap$_empty(t1, t1), H._asIntNullable(J.$index$asx(data, "id")), new P.DateTime(Date.now(), false), new P.DateTime(Date.now(), false));
              t1.voice = "My Patch";
              t1.type = "patch";
      ...
      return P._asyncStartSync($async$_createSynthPatch$1, $async$completer);
    },
    _getSynthPatch$1: function(id) {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(type$.SynthPatch),
        $async$returnValue, $async$self = this, t1, data;
      var $async$_getSynthPatch$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return P._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return P._asyncAwait($async$self._sendJSON$1("/api/patch/" + H.S(id) + "/"), $async$_getSynthPatch$1);
            case 3:
              // returning from await.
              data = $async$result;
              if (data == null)
              ...
              t1 = type$.dynamic;
              t1 = new Y.SynthPatch(P.LinkedHashMap_LinkedHashMap$_empty(t1, t1), id, new P.DateTime(Date.now(), false), new P.DateTime(Date.now(), false));
              t1.voice = "My Patch";
              t1.type = "patch";
              t1.load$1(0, type$.Map_dynamic_dynamic._as(data));
              $async$returnValue = t1;
      ...
      return P._asyncStartSync($async$_getSynthPatch$1, $async$completer);
    },
    _updateSynthPatch$1: function(patch) {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(type$.SynthPatch),
        $async$returnValue, $async$self = this, data, t1;
      var $async$_updateSynthPatch$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return P._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              patch.username = $async$self.user.displayName;
              $async$goto = 3;
              return P._asyncAwait($async$self._sendJSON$3("/api/patch/" + H.S(patch.id) + "/", "PUT", patch.save$0(0)), $async$_updateSynthPatch$1);
            case 3:
              // returning from await.
              data = $async$result;
              if (data == null)
      ...
      return P._asyncStartSync($async$_updateSynthPatch$1, $async$completer);
    },
    _deleteSynthPatch$1: function(patch) {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(type$.SynthPatch),
        $async$returnValue, $async$self = this, t1, data, $async$temp1;
      var $async$_deleteSynthPatch$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return P._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              data = patch.save$0(0);
              if (data.containsKey$1(0, "preview"))
                data.$indexSet(0, "preview", null);
              $async$temp1 = type$.Map_dynamic_dynamic;
              $async$goto = 3;
              return P._asyncAwait($async$self._sendJSON$3("/api/patch/" + H.S(patch.id) + "/", "DELETE", data), $async$_deleteSynthPatch$1);
            case 3:
              // returning from await.
              data = $async$temp1._as($async$result);
              t1 = type$.dynamic;
              t1 = new Y.SynthPatch(P.LinkedHashMap_LinkedHashMap$_empty(t1, t1), H._asIntNullable(J.$index$asx(data, "id")), new P.DateTime(Date.now(), false), new P.DateTime(Date.now(), false));
              t1.voice = "My Patch";
              t1.type = "patch";
      ...
      return P._asyncStartSync($async$_deleteSynthPatch$1, $async$completer);
    },
            ...
            case 3:
              ...
              if (type$.List_dynamic._is(data))
                for (t1 = J.get$iterator$ax(data), t2 = type$.Map_dynamic_dynamic, t3 = type$.dynamic; t1.moveNext$0();) {
                  p = t1.get$current();
                  if (t2._is(p)) {
                    t4 = new Y.SynthPatch(P.LinkedHashMap_LinkedHashMap$_empty(t3, t3), H._asIntNullable(J.$index$asx(p, "id")), new P.DateTime(Date.now(), false), new P.DateTime(Date.now(), false));
                    t4.voice = "My Patch";
                    t4.type = "patch";
                    t4.load$1(0, p);
    ...
    _broadcastEvent$1: function($event) {
      ...
      if (t1 === 1) {
        ...
        t1 = type$.dynamic;
        this.socket.send(C.C_JsonCodec.encode$2$toEncodable(P.LinkedHashMap_LinkedHashMap$_literal(["action", "datastore-event", "clientId", this.wid, "path", path, "event", P.LinkedHashMap_LinkedHashMap$_literal(["target", $event.target.save$0(0), "type", $event.type, "remote", $event.remote], t1, t1)], type$.String, type$.Object), null));
      }
    },
    _handleSocketMessage$1: function(message) {
      ...
      try {
        ...
        if (_this.wid === J.$index$asx(data, "clientId"))
          return;
        $event = Y.DatastoreEvent$fromJson(t1._as(J.$index$asx(data, "event")));
  ...
  Y.Datastore$rest_closure.prototype = {
    call$1: function(e) {
      P.print("Socket error: " + H.S(e));
    },
    $signature: 5
  };
  Y.Datastore$rest_closure0.prototype = {
    call$1: function(e) {
  ...
  Y.DatastoreEvent.prototype = {
    DatastoreEvent$fromJson$1: function(json) {
      var t1, t2, _this = this;
      if (json == null)
        return;
      t1 = J.getInterceptor$asx(json);
      _this.target = Y.DataModel_DataModel$fromJson(type$.Map_dynamic_dynamic._as(t1.$index(json, "target")));
  ...
  Y.SynthPatch.prototype = {
    save$0: function(_) {
      var t1, _this = this;
      _this.modified = new P.DateTime(Date.now(), false);
      t1 = type$.dynamic;
      return P.LinkedHashMap_LinkedHashMap$_literal(["id", _this.id, "type", _this.type, "voice", _this.voice, "instrument", _this.instrument, "patch", _this.patch, "description", _this.description, "username", _this.username, "preview", null, "created", _this.created.toString$0(0), "modified", _this.modified.toString$0(0), "like_count", _this.like_count, "star_count", _this.star_count, "remix_count", _this.remix_count, "public", _this.$public, "deleted", _this.deleted], t1, t1);
    },
  ...
  Y.User.prototype = {
    save$0: function(_) {
      ...
      t1 = type$.dynamic;
      return P.LinkedHashMap_LinkedHashMap$_literal(["id", J.toString$0$(_this.id), "username", _this.name, "displayName", _this.displayName, "email", _this.email, "anonymous", _this.anonymous, "color", _this.color, "icon", _this.icon, "photo", _this.photo, "created", _this.created.toString$0(0), "modified", _this.modified.toString$0(0)], t1, t1);
    },
  ...
  V.SynthDesigner.prototype = {
    ...
    load$1: function(_, config) {
      ...
      if (t2._is(t1.$index(config, "routing")) && _this.nodes.__js_helper$_length > 0)
        for (t1 = J.get$iterator$ax(type$.Iterable_dynamic._as(t1.$index(config, "routing"))), t2 = _this.nodes; t1.moveNext$0();) {
          r = t1.get$current();
          t3 = J.getInterceptor$asx(r);
          source = t2.$index(0, t3.$index(r, "source"));
    ...
    get$isDraggingLink: function() {
      var t1, t2;
      for (t1 = this.nodes, t1 = t1.get$values(t1), t2 = H._instanceType(t1), t2 = new H.MappedIterator(J.get$iterator$ax(t1.__internal$_iterable), t1._f, t2._eval$1("@<1>")._bind$1(t2._rest[1])._eval$1("MappedIterator<1,2>")); t2.moveNext$0();)
        if (t2.__internal$_current.get$isDraggingLink())
          return true;
      return false;
    },
    draw$0: function() {
    ...
    clearNodes$0: function() {
      var t1, t2, t3;
      for (t1 = this.nodes, t2 = t1.get$values(t1), t3 = H._instanceType(t2), t3 = new H.MappedIterator(J.get$iterator$ax(t2.__internal$_iterable), t2._f, t3._eval$1("@<1>")._bind$1(t3._rest[1])._eval$1("MappedIterator<1,2>")), t2 = this.touchables; t3.moveNext$0();)
        C.JSArray_methods.remove$1(t2, t3.__internal$_current);
      t1.clear$0(0);
    },
    ...
    animate$0: function(_) {
      var t1, t2, refresh;
      for (t1 = this.nodes, t1 = t1.get$values(t1), t2 = H._instanceType(t1), t2 = new H.MappedIterator(J.get$iterator$ax(t1.__internal$_iterable), t1._f, t2._eval$1("@<1>")._bind$1(t2._rest[1])._eval$1("MappedIterator<1,2>")), refresh = false; t2.moveNext$0();)
        if (t2.__internal$_current.animate$0(0))
          refresh = true;
      return refresh;
    },
    ...
    overlappingSocket$1: function(link) {
      var t1, t2, socket;
      for (t1 = this.nodes, t1 = t1.get$values(t1), t2 = H._instanceType(t1), t2 = new H.MappedIterator(J.get$iterator$ax(t1.__internal$_iterable), t1._f, t2._eval$1("@<1>")._bind$1(t2._rest[1])._eval$1("MappedIterator<1,2>")); t2.moveNext$0();) {
        socket = t2.__internal$_current.overlappingSocket$1(link);
        if (socket != null)
          return socket;
      }
      return null;
    ...
    toJSON$0: function() {
      ...
      for (t1 = this.nodes, t1 = t1.get$values(t1), t2 = H._instanceType(t1), t2 = new H.MappedIterator(J.get$iterator$ax(t1.__internal$_iterable), t1._f, t2._eval$1("@<1>")._bind$1(t2._rest[1])._eval$1("MappedIterator<1,2>")); t2.moveNext$0();) {
        ...
        if (m != null) {
          ...
          for (t1 = t1.links, t3 = t1.length, _i = 0; _i < t1.length; t1.length === t3 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
            c = t1[_i].toJSON$0();
            if (c != null)
  ...
  B.DNode.prototype = {
    ...
    DNode$3: function(designer, $name, config) {
      var _this = this,
        t1 = _this.config,
        t2 = J.getInterceptor$asx(t1);
      _this.cx = B.toNum(t2.$index(t1, "cx"), 100);
      _this.cy = B.toNum(t2.$index(t1, "cy"), 100);
  ...
  B.DADSRNode.prototype = {
    DADSRNode$3: function(designer, $name, config) {
      ...
      t1.$indexSet(config, "A", B.toNum(t1.$index(config, "A"), 0.01));
      t1.$indexSet(config, "D", B.toNum(t1.$index(config, "D"), 0.1));
      t1.$indexSet(config, "S", B.toNum(t1.$index(config, "S"), 1));
      t1.$indexSet(config, "R", B.toNum(t1.$index(config, "R"), 0.3));
      t1.$indexSet(config, _s5_, B.toNum(t1.$index(config, _s5_), 1));
      _this.label = "ADSR";
      t2 = _this.params;
    ...
    _timeToX$1: function(time) {
      var t1 = this.config,
        t2 = J.getInterceptor$asx(t1),
        t3 = B.toNum(t2.$index(t1, "A"), 0.01),
        t4 = B.toNum(t2.$index(t1, "D"), 0.1);
      if (typeof t3 !== "number")
        return t3.$add();
      if (typeof t4 !== "number")
        return H.iae(t4);
      t1 = B.toNum(t2.$index(t1, "R"), 0.3);
      if (typeof t1 !== "number")
        return H.iae(t1);
      t2 = this.cx;
      if (typeof t2 !== "number")
    ...
    draw$2: function(ctx, highlight) {
      ...
      ctx.lineTo(_this._timeToX$1(B.toNum(t1.$index(t2, "A"), 0.01)), _this._gainToY$1(1));
      t3 = B.toNum(t1.$index(t2, "A"), 0.01);
      t4 = B.toNum(t1.$index(t2, "D"), 0.1);
      if (typeof t3 !== "number")
        return t3.$add();
      if (typeof t4 !== "number")
        return H.iae(t4);
      ctx.lineTo(_this._timeToX$1(t3 + t4), _this._gainToY$1(B.toNum(t1.$index(t2, "S"), 1)));
      t4 = B.toNum(t1.$index(t2, "A"), 0.01);
      t3 = B.toNum(t1.$index(t2, "D"), 0.1);
      if (typeof t4 !== "number")
        return t4.$add();
      if (typeof t3 !== "number")
        return H.iae(t3);
      ctx.lineTo(_this._timeToX$1(t4 + t3 + 1), _this._gainToY$1(B.toNum(t1.$index(t2, "S"), 1)));
      t3 = B.toNum(t1.$index(t2, "A"), 0.01);
      t4 = B.toNum(t1.$index(t2, "D"), 0.1);
      if (typeof t3 !== "number")
        return t3.$add();
  ...
  B.DLFONode.prototype = {
    DLFONode$3: function(designer, $name, config) {
      ...
      t1.$indexSet(config, _s5_, B.toNum(t1.$index(config, _s5_), 1));
      t1.$indexSet(config, _s9_, B.toNum(t1.$index(config, _s9_), 1));
  ...
  B.DDistNode.prototype = {
    DDistNode$3: function(designer, $name, config) {
      ...
      config.$indexSet(0, _s8_, B.toNum(config.$index(0, _s8_), 1));
      config.$indexSet(0, _s5_, B.toNum(config.$index(0, _s5_), 1));
      _this.label = $name;
      t1 = _this.params;
  ...
  B.DOscNode.prototype = {
    DOscNode$3: function(designer, $name, config) {
      ...
      t1.$indexSet(config, _s5_, B.toNum(t1.$index(config, _s5_), 1));
      t1.$indexSet(config, _s3_, B.toNum(t1.$index(config, _s3_), 100));
      t1.$indexSet(config, _s3_0, B.toNum(t1.$index(config, _s3_0), 400));
      t1.$indexSet(config, _s9_, B.toNum(t1.$index(config, _s9_), 1));
      t1.$indexSet(config, _s6_, B.toNum(t1.$index(config, _s6_), 0));
  ...
  B.DDelayNode.prototype = {
    DDelayNode$3: function(designer, $name, config) {
      ...
      config.$indexSet(0, _s5_0, B.toNum(config.$index(0, _s5_0), 1));
      config.$indexSet(0, _s5_, B.toNum(config.$index(0, _s5_), 0.1));
  ...
  B.DCompressorNode.prototype = {
    DCompressorNode$3: function(designer, $name, config) {
      ...
      t1.$indexSet(config, _s9_, B.toNum(t1.$index(config, _s9_), -24));
      t1.$indexSet(config, _s4_, B.toNum(t1.$index(config, _s4_), 30));
      t1.$indexSet(config, _s5_, B.toNum(t1.$index(config, _s5_), 12));
      t1.$indexSet(config, _s6_, B.toNum(t1.$index(config, _s6_), 0.003));
      t1.$indexSet(config, _s7_, B.toNum(t1.$index(config, _s7_), 0.25));
  ...
  B.DFilterNode.prototype = {
    DFilterNode$3: function(designer, $name, config) {
      ...
      t1.$indexSet(config, _s9_, B.toNum(t1.$index(config, _s9_), 350));
      t1.$indexSet(config, _s6_, B.toNum(t1.$index(config, _s6_), 0));
      t1.$indexSet(config, "Q", B.toNum(t1.$index(config, "Q"), 1));
      t1.$indexSet(config, _s4_0, B.toNum(t1.$index(config, _s4_0), 0));
  ...
  (function installTearOffs() {
    ...
    _instance_1_i(P._BroadcastStreamController.prototype, "get$add", "add$1", 69);
    ...
    _static_1(P, "js___convertToDart$closure", "_convertToDart", 68);
    var _;
    _instance_1_u(_ = U.MIDIManager.prototype, "get$_midiConnection", "_midiConnection$1", 21);
    _instance_1_u(_, "get$_midiEvent", "_midiEvent$1", 21);
    _instance_1_u(Y.Datastore.prototype, "get$_handleSocketMessage", "_handleSocketMessage$1", 6);
    _static_1(F, "main__draw$closure", "draw", 24);
    _static_1(F, "main__patchCreated$closure", "patchCreated", 10);
    _static_1(F, "main__patchDeleted$closure", "patchDeleted", 10);
    _static_1(F, "main__patchUpdated$closure", "patchUpdated", 10);
  })();
  (function inheritance() {
    ...
    _inheritMany(Y.DataModel, [Y.SynthPatch, Y.Recording, Y.User]);
